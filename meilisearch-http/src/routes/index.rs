...
use heed::RoTxn;
use log::error;
use meilisearch_core::{MainT, UpdateT, Database};
...
pub fn list_indexes_sync(data: &web::Data<Data>, reader: &RoTxn<MainT>) -> Result<Vec<IndexResponse>, ResponseError> {
