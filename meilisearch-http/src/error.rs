...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::BackupAlreadyInProgress => f.write_str("Another backup is already in progress, please try again later"),
            Self::BackupProcessFailed => f.write_str("Backup process failed, backup may be corrupted"),
        }
    }
}
